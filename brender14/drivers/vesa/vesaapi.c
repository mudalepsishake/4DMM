...
br_error VESAInfo(struct vesa_info *vip)
{
     ...
     */
    /* BRenderModern: VBE 2.0 applications should preset this field with the ASCII characters 'VBE2' */
    ...
    /* BRenderModern: Upon return from VBE Function 00h, this field should always be set to 'VESA' by the VBE implementation. */
