...
static br_error BR_CMETHOD_DECL(br_device_clut_sdl3, entrySetMany)(br_device_clut *self, br_int_32 index, br_int_32 count, br_colour *entries)
{
    return DeviceSDL3SetPalette(self->pal, index, count, entries, BR_FALSE);
}

static br_error BR_CMETHOD_DECL(br_device_clut_sdl3, entryQueryMany)(br_device_clut *self, br_colour *entries, br_int_32 index, br_int_32 count)
{
