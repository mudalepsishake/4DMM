...
static void GEOMETRY_CALL V1Face_CullNone(br_geometry *self, br_renderer *renderer)
{
    ...
    // BRender:        rend.nvisible_faces = rend.nfaces;
}
...
#else
        rend.faces = NULL; // BRender: model->groups[g].faces;
#endif
#if 1
...
#else
        rend.vertices = NULL; // BRender: model->groups[g].vertices;
#endif
