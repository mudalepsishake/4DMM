 ...
 */
static void GEOMETRY_CALL Vertex_TransformProjectOutcodeBounds(br_geometry *self, br_renderer *renderer)
{
    int         v;
 ...
 */
static void GEOMETRY_CALL Vertex_TransformProjectOutcode(br_geometry *self, br_renderer *renderer)
{
    int         v;
    brp_vertex *tvp = rend.temp_vertices;
 ...
 */
static void GEOMETRY_CALL Vertex_OS_TransformProjectBounds(br_geometry *self, br_renderer *renderer)
{
    int         v;
    brp_vertex *tvp = rend.temp_vertices;
 ...
 */
static void GEOMETRY_CALL Vertex_OS_TransformProject(br_geometry *self, br_renderer *renderer)
{
    int         v;
    brp_vertex *tvp = rend.temp_vertices;
 ...
 */
static void GEOMETRY_CALL Vertex_OS_TransformProjectBoundsSurf(br_geometry *self, br_renderer *renderer)
{
    int         v, i;
    brp_vertex *tvp    = rend.temp_vertices;
 ...
 */
static void GEOMETRY_CALL Vertex_OS_TransformProjectSurf(br_geometry *self, br_renderer *renderer)
{
    int         v, i;
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
 ...
 * Transform, project, light and update screen bounds of visible vertices
 */
static void GEOMETRY_CALL Vertex_OS_TransformProjectBoundsGeom(br_geometry *self, br_renderer *renderer)
{
    int         v, i;
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
...
static void GEOMETRY_CALL Vertex_OS_TransformProjectGeom(br_geometry *self, br_renderer *renderer)
{
    int         v, i;
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
...
static void GEOMETRY_CALL Vertex_OSV_TransformProjectBounds(br_geometry *self, br_renderer *renderer)
{
	int v;
	brp_vertex *tvp = rend.temp_vertices;
...
static void GEOMETRY_CALL Vertex_OSV_TransformProject(br_geometry *self, br_renderer *renderer)
{
	int v;
	brp_vertex *tvp = rend.temp_vertices;
...
static void GEOMETRY_CALL Vertex_SurfaceComponentsSurf(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
    br_vector2 *vp_map = rend.vertex_map;
...
static void GEOMETRY_CALL Vertex_SurfaceComponentsTwoSidedSurf(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
    br_vector2 *vp_map = rend.vertex_map;
...
static void GEOMETRY_CALL Vertex_SurfaceComponentsGeom(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
    br_vector2 *vp_map = rend.vertex_map;
...
static void GEOMETRY_CALL Vertex_SurfaceComponentsTwoSidedGeom(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp    = rend.temp_vertices;
    br_vector3 *vp_p   = rend.vertex_p;
    br_vector2 *vp_map = rend.vertex_map;
...
static void GEOMETRY_CALL Vertex_ForceFront(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp = rend.temp_vertices;
    int         v;
...
static void GEOMETRY_CALL Vertex_ForceBack(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp = rend.temp_vertices;
    int         v;
...
static void GEOMETRY_CALL Vertex_DepthBias(br_geometry *self, br_renderer *renderer)
{
    brp_vertex *tvp = rend.temp_vertices;
    int         v;
    br_scalar   min, max;
