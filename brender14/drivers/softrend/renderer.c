...
static const struct br_renderer_dispatch rendererDispatch = {
    ...
    ._modelMul              = BR_CMETHOD_REF(br_renderer_soft, modelMul),
    ._modelPopPushMul       = BR_CMETHOD_REF(br_renderer_soft, modelPopPushMul),
    ...
    ._boundsTest            = BR_CMETHOD_REF(br_renderer_soft, boundsTest),
