...
static const char *BR_CMETHOD_DECL(br_device_clut_sdl2, identifier)(br_object *self)
{
...
static br_size_t BR_CMETHOD_DECL(br_device_clut_sdl2, space)(br_object *self)
{
