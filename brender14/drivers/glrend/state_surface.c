...
static const state_surface default_state = {
    ...
    .opacity_source = BRT_SURFACE,      /* BRenderModern: BRT_GEOMETRY */
    .mapping_source = BRT_GEOMETRY_MAP, /* BRenderModern: BRT_ENVIRONMENT_LOCAL, BRT_ENVIRONMENT_INFINITE, BRT_QUAD, BRT_GEOMETRY_{X,Y,Z} */
