...
enum {
    BUFFER_RING_GL_FLAG_ORPHAN = (1 << 0), /** BRenderModern: < Orphan the buffer each draw instead of appending to. */
...
typedef struct br_renderer {
    ...
    int has_begun;
    br_boolean shadow_pass_active;
    br_boolean shadow_blocker_pass_active;
    br_boolean shadow_detail_pass_active;
