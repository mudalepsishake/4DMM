...
const static br_pixelmap_gl_fmt br2gl[BR_PMT_MAX] = {
    ...
    BRPM_TO_GL(BR_PMT_DEPTH_16,      GL_DEPTH_COMPONENT16,    GL_DEPTH_COMPONENT, 0,         2, BR_FALSE, BR_FALSE, RED, GREEN, BLUE, ALPHA), /* BRenderModern: mandatory */
    BRPM_TO_GL(BR_PMT_DEPTH_24,      GL_DEPTH_COMPONENT24,    GL_DEPTH_COMPONENT, 0,         3, BR_FALSE, BR_FALSE, RED, GREEN, BLUE, ALPHA), /* BRenderModern: mandatory */
    BRPM_TO_GL(BR_PMT_DEPTH_32,      GL_DEPTH_COMPONENT32,    GL_DEPTH_COMPONENT, 0,         4, BR_FALSE, BR_FALSE, RED, GREEN, BLUE, ALPHA),
    BRPM_TO_GL(BR_PMT_DEPTH_FP32,    GL_DEPTH_COMPONENT32F,   GL_DEPTH_COMPONENT, GL_FLOAT,  4, BR_FALSE, BR_FALSE, RED, GREEN, BLUE, ALPHA), /* BRenderModern: mandatory */
