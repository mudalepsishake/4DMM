...
static br_tv_template_entry devicePixelmapTemplateEntries[] = {
    ...
    // BRenderModern:	{BRT_PIXEL_CHANNELS_TL,	0,	0,					BRTV_QUERY | BRTV_ALL,	BRTV_CONV_CUSTOM },
    // BRenderModern:	{BRT_INDEXED_B,			0,	F(indexed),			BRTV_QUERY | BRTV_ALL,	BRTV_CONV_COPY },
