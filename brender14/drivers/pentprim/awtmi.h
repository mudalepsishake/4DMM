...
{
    /* BRender: v[0] and v[1] contain the (fractional) screen coordinates */
    /* BRender: And comp_x[C_W] contain the 3-space z-value */

    /* BRender: (v[0]-width/2)*comp_x[C_W] gives the 3-space x-values */
    /* BRender: Similarly for y */
