...
// BRender: void BR_ASM_CALL TriangleRenderPITD(brp_block *block, brp_vertex *v0, brp_vertex *v1,brp_vertex *v2);
// BRender: void BR_ASM_CALL TriangleRenderPITID(brp_block *block, brp_vertex *v0, brp_vertex *v1,brp_vertex *v2);
