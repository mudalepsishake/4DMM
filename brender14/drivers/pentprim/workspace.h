...
#define alignas(x) /* BRenderModern: NB: This is fixed with a regex in mkdrv.pl */
#else
#include <stdalign.h>
#endif
 ...
 */
struct _workspace {
    /* BRenderModern: qwords start here (pair-of-dword usage) */
    br_uint_32 xm;
    br_uint_32 d_xm;
    br_uint_32 x1;
    br_uint_32 d_x1;
    ...
    /* BRenderModern: qwords end here */

    /* BRenderModern: input to setup code */
    brp_vertex *v0;
    brp_vertex *v1;
    brp_vertex *v2;

    /* BRenderModern: only used within setup */
    br_uint_32 iarea;
    br_uint_32 dx1_a;
    br_uint_32 dx2_a;
    br_uint_32 dy1_a;
    ...
    /* BRenderModern: results from setup */
    br_uint_32 t_y;
    br_uint_32 flip;

    /* BRenderModern: used in some rasterisers */
    br_uint_32 c_z;
    br_uint_32 c_u;
    br_uint_32 c_v;
    br_uint_32 c_i;

    /* BRenderModern: tsbHeader-ish: counts union */
    union {
        br_uint_32 l;    /* BRenderModern: dword */
        br_int_16  s[2]; /* BRenderModern: two SWORDs */
    } counts;

    /* BRenderModern: Fixed setup only */
    br_uint_32 v0_x;
    br_uint_32 v1_x;
    br_uint_32 v2_x;
    br_uint_32 v0_y;
    ...
    /* BRenderModern: my stuff, currently in here for my convenience -JohnG */
    br_uint_32 xm_f;
    br_uint_32 d_xm_f;
    ...
    br_uint_32 colour; /* BRenderModern: align 8 */
    br_uint_32 colourExtension;
    br_uint_32 shadeTable;

    br_uint_32 _pad1; /* BRenderModern: align 8 */
    br_uint_32 scratch0;
    br_uint_32 scratch1;
    br_uint_32 scratch2;
    br_uint_32 scratch3;
...
#endif /* BRenderModern: _WORKSPACE_H_ */
