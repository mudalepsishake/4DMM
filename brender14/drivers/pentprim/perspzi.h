...
FNAME(struct brp_block *block, union brp_vertex *a,union brp_vertex *b,union brp_vertex *c)
{
    ...
    /* BRender: Optimal sort of 3 elements? */
...
#define PARAM_SETUP_UNSIGNED(param,p) {\
    ...
    /* BRender: Shift right by half a pixel */
    ...
    /* BRender: u_numerator and v_numerator are the 'Bresenham style' error terms */
...
#define PDIVIDE \
	...
	/* BRender: Start of second innermost loop */
	...
	/* BRender: End of second innermost loop */
    }
