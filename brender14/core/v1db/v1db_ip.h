...
br_buffer_stored *BrBufferStoredGet(br_pixelmap *map);
 ...
 * modrend.c
 */
typedef void br_render_style_call_fn(br_actor *actor, br_model *model, br_material *material, void *render_data, br_uint_8 style, int on_screen);
