...
{
    /* BRenderModern: get class and subclass ids and names */
    ...
    /* BRenderModern: add null terminator */
    fw.last_error_string[BR_ASIZE(fw.last_error_string) - 1] = '\0';

    /* BRenderModern: return ptr to buffer */
