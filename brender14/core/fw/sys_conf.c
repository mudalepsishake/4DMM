...
// BRender: extern br_framework_state BR_ASM_DATA fw ;
...
br_error BrSystemConfigBegin()
{
     ...
     */
    BrSprintf(version, "%d.%d.%d", (__BRENDER__ & 0xff0000) >> 16, (__BRENDER__ & 0x00ff00) >> 8, (__BRENDER__ & 0x0000ff));
...
br_error BR_PUBLIC_ENTRY BrSystemConfigSave(br_token t, const char *param1, const void *param2)
{
    ...
    switch(t) {
        ...
        case BRT_INI_STR:
            ...
            return BrWriteIniSection(fw.sys_config, param1, param2);
...
static br_error parseEntryLine(br_lexer *l, br_token_value *tv, br_size_t size)
{
    ...
    if(BrLexerCurrent(l) == T_COLON || BrLexerCurrent(l) == T_EQUAL) {
        ...
        switch((int)BrLexerCurrent(l)) {
             ...
             */
            case T_INTEGER: {
                static br_token pos_int_types[] = {BRT_INTPTR,  BRT_UINTPTR, BRT_INT_64,  BRT_UINT_64,   BRT_INT_32,
                                                   BRT_UINT_32, BRT_INT_16,  BRT_UINT_16, BRT_INT_8,     BRT_UINT_8,
                                                   BRT_FLOAT,   BRT_FIXED,   BRT_BOOLEAN, BRT_COLOUR_RGB};
                static br_token neg_int_types[] = {BRT_INTPTR, BRT_INT_64, BRT_INT_32, BRT_INT_16,
                                                   BRT_INT_8,  BRT_FLOAT,  BRT_FIXED,  BRT_BOOLEAN};
