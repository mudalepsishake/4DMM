...
static char *member_type_names[] = {
    ...
    [FSM_FLOAT]           = "float",
    [FSM_ANGLE_SCALAR]    = "angle", /* BRenderModern: FIXME: verify the order of these. */
    [FSM_DOUBLE]          = "double",
    [FSM_SCALAR]          = "scalar",
...
static br_uint_32 DfStructSizeText(br_datafile *df, br_file_struct *str, void *base)
{
    unsigned int           m;
    br_file_struct_member *sm;
    br_uint_32             lines = 1; /* BRender: Structure has 1 line header */
