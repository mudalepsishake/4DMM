...
static br_resource_class resourceClasses[] = {
    ...
    /*
     * BRender 1.1/3DMM registered these in the framework resource table.
     * Modern BRender kept the numeric IDs, but removed their classes. The
     * 3DMM model ABI still allocates all three, so restore the classes only
     * for the compatibility build.
     */
    {0, "GROUPS",             BR_MEMORY_GROUPS,             NULL,          0 },
    {0, "PREPARED_VERTICES",  BR_MEMORY_PREPARED_VERTICES,  NULL,          0 },
    {0, "PREPARED_FACES",     BR_MEMORY_PREPARED_FACES,     NULL,          0 },
#endif
...
br_error BR_PUBLIC_ENTRY BrFwBegin(void)
{
    ...
    // BRender: Mark default drivers as still to be loaded.
...
static const br_image_function_info functions[] = {
    ...
    REGMETHOD(BrGetEnv),
    REGMETHOD(BrHash),
    REGMETHOD(BrHashMapAllocate),
    REGMETHOD(BrHashMapClear),
    REGMETHOD(BrHashMapSetResizePolicy),
    REGMETHOD(BrHashMapSetLoadFactor),
    REGMETHOD(BrHashMapReset),
    REGMETHOD(BrHashMapFree),
    REGMETHOD(BrHashMapResize),
    REGMETHOD(BrHashMapInsert),
    REGMETHOD(BrHashMapFindByHash),
    REGMETHOD(BrHashMapFind),
    REGMETHOD(BrHashMapRemove),
    REGMETHOD(BrHashMapSize),
    REGMETHOD(BrHashMapEnumerate),
    REGMETHOD(BrHashMapDefaultHash),
    REGMETHOD(BrHashMapDefaultCompare),
    REGMETHOD(BrHashMapStringHash),
    REGMETHOD(BrHashMapStringCompare),
