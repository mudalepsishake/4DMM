 ...
 */
br_error BR_RESIDENT_ENTRY BrRendererFacilityListFind(br_renderer_facility **prf, br_int_32 *num_rf, br_int_32 max_rf,
    ...
    *num_rf = 0;
    ...
    if(scalar_is_valid) {
        ...
        *num_rf += renderer_facility_count;
         ...
         */
        r = BrDevContainedCount(&renderer_facility_size, BRT_RENDERER_FACILITY, "*-Renderer", is_alternative);
 ...
 */
br_error BR_RESIDENT_ENTRY BrPrimitiveLibraryListFind(br_primitive_library **ppl, br_int_32 *num_pl, br_int_32 max_pl,
                                                      br_device_pixelmap *destination, br_token scalar_type)
{
    br_primitive_library **primitive_library      = NULL;
    ...
    *num_pl = 0;
    ...
    if(scalar_is_valid) {
        ...
        *num_pl += primitive_library_count;
         ...
         * Now search for non-scalar-specific alternatives
         */
        r = BrDevContainedCount(&primitive_library_size, BRT_PRIMITIVE_LIBRARY, "*-Primitives", is_alternative);
