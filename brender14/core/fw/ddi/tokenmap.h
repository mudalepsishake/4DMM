 ...
 */
enum br_tv_flag {
    BRTV_QUERY = 0x0001, /* BRender: This entry is valid for Query operations	*/
    BRTV_SET   = 0x0002, /* BRender: This entry is valid for Set operations	*/
    BRTV_ALL   = 0x0004, /* BRender: This entry is valid for QueryAll operations	*/

    BRTV_ABS = 0x0008 /* BRender: 'offset' member of template contains value	*/
};
