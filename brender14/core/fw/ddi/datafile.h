...
enum {
    ...
    FID_IMAGE_PLANE,     /* BRender: UNUSED */
    FID_RLE_IMAGE_PLANE, /* BRender: UNUSED */
    FID_OLD_PIXELMAP,

    FID_MATERIAL_OLDEST,
    FID_ADD_MATERIAL, /* BRender: UNUSED */

    FID_OLD_ACTOR,       /* BRender: UNUSED */
    FID_OLD_ADD_SIBLING, /* BRender: UNUSED */
    FID_OLD_ADD_CHILD,   /* BRender: UNUSED */
    ...
    FID_ANIM_RATE,
    FID_FILE_INFO,
    FID_OLD_LIGHT,  /* BRender: UNUSED */
    FID_OLD_CAMERA, /* BRender: UNUSED */
    FID_PIVOT,
    ...
    FID_COLOUR_MAP_REF,
    FID_OPACITY_MAP_REF, /* BRender: UNUSED */
    FID_INDEX_BLEND_REF,
    FID_INDEX_SHADE_REF,
    FID_SCREENDOOR_REF,
...
enum {
    ...
    /* BRender:	FILE_TYPE_MODEL, */
    FILE_TYPE_ACTORS,
    /* BRender:	FILE_TYPE_ANIMATION, */
    FILE_TYPE_PIXELMAP,
    FILE_TYPE_LIGHT,
    FILE_TYPE_CAMERA,
...
typedef struct br_file_struct_member {
    br_uint_16 type;   /* BRender: Type of member 							*/
    br_size_t  offset; /* BRender: Offset in memory from base of structure	*/
    char      *name;   /* BRender: text identifier for debug purposes		*/
    void      *extra;  /* BRender: Any extra type data						*/
...
typedef struct br_file_primitives {
    ...
    br_size_t (*count_size)(br_datafile *df);
    ...
    br_uint_32 (*struct_size)(br_datafile *df, br_file_struct *str, void *base);
