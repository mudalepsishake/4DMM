 ...
 */
// BRender: char * BR_RESIDENT_ENTRY GetWinProfileString(char *name);
char *BR_RESIDENT_ENTRY GetWinRegistryValue(char *name);

/* BRender:
 * cpuid.asm
 */
// BRenderModern: void BR_ASM_CALL CPUInfo(br_token *cpu_type, br_uint_32 *features);

/* BRenderModern: CPUInfo.c
 *
 */
