...
// BRender: Read requested environment variable. If not set, use one of our
// BRender: defaults if applicable.
...
// BRender: INI file & registry queries are currently only defined under Windows.
// BRender: We should add ini file parsing from DOS if anyone can be arsed.
