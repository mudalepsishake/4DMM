...
br_pixelmap *BR_PUBLIC_ENTRY BrPixelmapAllocateSub(br_pixelmap *src, br_int_32 x, br_int_32 y, br_int_32 w, br_int_32 h)
{
    br_pixelmap *new;
    br_rectangle r;
...
br_pixelmap *BR_PUBLIC_ENTRY BrPixelmapResize(br_pixelmap *src, br_int_32 width, br_int_32 height)
{
    UASSERT(src);
...
void BR_PUBLIC_ENTRY BrPixelmapDirtyRectangleCopy(br_pixelmap *dst, br_pixelmap *src, br_int_32 x, br_int_32 y, br_int_32 w, br_int_32 h)
{
    ...
    UASSERT((src->width == dst->width) && (src->height == dst->height));
