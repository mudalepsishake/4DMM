...
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleStretchCopyTo)(br_device_pixelmap *self, br_rectangle *d,
                                                                          br_device_pixelmap *src, br_rectangle *s)
{
    return BRE_OK;
}

br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleStretchCopyFrom)(br_device_pixelmap *self, br_rectangle *d,
                                                                            br_device_pixelmap *src, br_rectangle *s)
{
    return BRE_OK;
}
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, pixelSet)(br_device_pixelmap *self, br_point *p, br_uint_32 colour)
{
    return BRE_OK;
}

br_error BR_CMETHOD_DECL(br_device_pixelmap_null, copyBits)(br_device_pixelmap *self, br_point *point, const br_uint_8 *src,
 ...
 * Reading back
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, pixelQuery)(br_device_pixelmap *self, br_uint_32 *pcolour, br_point *p)
{
    return BRE_OK;
}
