...
typedef struct br_material {
    ...
    // BRender: Eight bit ambient ambient lighting level.
    br_ufraction ka;
    br_ufraction kd;
    br_ufraction ks;
    ...
    br_pixelmap *index_fog;   /* BRender: Index fogging        */
 ...
 */
enum {
    BR_MAPU_DATA = 0x0001, // BRenderModern: If this flag is ommitted the driver gets a chance to free the original (assuming
                           // BRenderModern: KEEP_ORIGINAL not set) without doing any extra work.
    BR_MAPU_ALL    = 0x0fff,
