...
/* BRenderModern: Bot enough arguments for function-like macro invocation 'BR_PIXELMAP_MEMBERS_PREFIXED' */
#pragma warning(disable : 4003)

/* BRenderModern: This function or variable may be unsafe. Consider using XXXXXX instead. */
...
#define BR_PUBLIC_VA __cdecl /* BRender: varargs version */

/* BRender:
 * Entry point exported to drivers via modules
 */
#define BR_EXPORT    __cdecl
#define BR_EXPORT_VA __cdecl /* BRender: varargs version */

/* BRender:
 * A driver object method
 */
#define BR_METHOD    __cdecl
#define BR_METHOD_VA __cdecl /* BRender: varargs version */
 ...
 */
#define BR_PUBLIC
#define BR_PUBLIC_VA /* BRender: varargs version */

/* BRender:
 * Entry point exported to drivers via modules
 */
#define BR_EXPORT
#define BR_EXPORT_VA /* BRender: varargs version */

/* BRender:
 * A driver object method
 */
#define BR_METHOD
#define BR_METHOD_VA /* BRender: varargs version */
