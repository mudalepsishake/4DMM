...
typedef union {
    ...
    struct {
        br_scalar s, t; // BRender: texture coords
    };
} br_vector2;
#else
...
typedef union {
    br_scalar v[4];
    struct {
        br_scalar x, y, z; // BRender: homogeneous coordinates
        union {
            br_scalar d;
            br_scalar w;
        };
...
typedef struct br_bounds2_f {
    br_vector2_f min; /* BRender: Minimum corner */
    br_vector2_f max; /* BRender: Maximum corner */
} br_bounds2_f;

typedef struct br_bounds3_f {
    br_vector3_f min; /* BRender: Minimum corner */
    br_vector3_f max; /* BRender: Maximum corner */
} br_bounds3_f;

typedef struct br_bounds4_f {
    br_vector4_f min; /* BRender: Minimum corner */
    br_vector4_f max; /* BRender: Maximum corner */
} br_bounds4_f;
...
typedef struct br_bounds2_x {
    br_vector2_x min; /* BRender: Minimum corner */
    br_vector2_x max; /* BRender: Maximum corner */
} br_bounds2_x;

typedef struct br_bounds3_x {
    br_vector3_x min; /* BRender: Minimum corner */
    br_vector3_x max; /* BRender: Maximum corner */
} br_bounds3_x;

typedef struct br_bounds4_x {
    br_vector4_x min; /* BRender: Minimum corner */
    br_vector4_x max; /* BRender: Maximum corner */
} br_bounds4_x;
...
typedef struct br_bounds2_i {
    br_vector2_i min; /* BRender: Minimum corner */
    br_vector2_i max; /* BRender: Maximum corner */
} br_bounds2_i;

typedef struct br_bounds3_i {
    br_vector3_i min; /* BRender: Minimum corner */
    br_vector3_i max; /* BRender: Maximum corner */
} br_bounds3_i;

typedef struct br_bounds4_i {
    br_vector4_i min; /* BRender: Minimum corner */
    br_vector4_i max; /* BRender: Maximum corner */
} br_bounds4_i;
