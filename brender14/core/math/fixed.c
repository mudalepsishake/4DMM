...
static const octant_info OctantInfo[] = {
    /* BRenderModern: Q0 */ [X_GT_0 | Y_GT_0 | XA_GT_YA] = {.offset = 0,             .mul =  1, .nidx = 1},
    /* BRenderModern: Q1 */ [X_GT_0 | Y_GT_0           ] = {.offset = BR_PI_2_LUF,   .mul = -1, .nidx = 0},
    /* BRenderModern: Q2 */ [         Y_GT_0           ] = {.offset = BR_PI_2_LUF,   .mul =  1, .nidx = 0},
    /* BRenderModern: Q3 */ [         Y_GT_0 | XA_GT_YA] = {.offset = BR_PI_LUF,     .mul = -1, .nidx = 1},
    /* BRenderModern: Q4 */ [                  XA_GT_YA] = {.offset = BR_PI_LUF,     .mul =  1, .nidx = 1},
    /* BRenderModern: Q5 */ [                         0] = {.offset = BR_3_PI_2_LUF, .mul = -1, .nidx = 0},
    /* BRenderModern: Q6 */ [X_GT_0                    ] = {.offset = BR_3_PI_2_LUF, .mul =  1, .nidx = 0},
    /* BRenderModern: Q7 */ [X_GT_0          | XA_GT_YA] = {.offset = 0, /* BRenderModern: 2*pi */  .mul = -1, .nidx = 1},
};
...
br_fixed_luf BrFixedATan2(br_fixed_ls y, br_fixed_ls x)
{
    ...
    /* BRenderModern: Handle the boundaries between quadrants. */
    if(abs_x == abs_y) {
        if(x > 0 && y < 0)
