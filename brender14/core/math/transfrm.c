...
br_uint_8 _CombineTransforms[BR_TRANSFORM_MAX][BR_TRANSFORM_MAX] = {
            /* BRender: M34, MLP, QUT, EUL, LUP, TRA, IDT */
    /* BRender: M34 */ {M34, M34, M34, M34, M34, M34, M34},
    /* BRender: MLP */ {M34, MLP, MLP, MLP, MLP, MLP, MLP},
    /* BRender: QUT */ {M34, MLP, MLP, MLP, MLP, QUT, QUT},
    /* BRender: EUL */ {M34, MLP, MLP, MLP, MLP, EUL, EUL},
    /* BRender: LUP */ {M34, MLP, MLP, MLP, MLP, LUP, LUP},
    /* BRender: TRA */ {M34, MLP, QUT, EUL, LUP, TRA, TRA},
    /* BRender: IDT */ {M34, MLP, QUT, EUL, LUP, TRA, IDT},
};
