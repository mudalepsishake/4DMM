...
/* BRenderModern: cbase64 - public domain base64 encoder/decoder
...
signed char cbase64__decode_value(char value_in)
{
                                  ...
                                  char* code_out, cbase64_encodestate* state_in)
{
    ...
    // BRenderModern: control should not reach here
    return codechar - code_out;
}
...
#endif // BRenderModern: CBASE64_IMPLEMENTATION
