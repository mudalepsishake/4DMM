...
#define INTRO_NUM_MODELS 2              /** BRenderModern: \brief brender, ball. */
#define INTRO_NUM_PIX    4              /** BRenderModern: \brief 2 textures, palette, shade table */
#define INTRO_ANIM_SIZE  98             /** BRenderModern: \brief Number of frames of animation in anim file. */
#define INTRO_DATFILE    "intro.dat"    /** BRenderModern: \brief Name of the model file. */
#define INTRO_PIXFILE    "intro.pix"    /** BRenderModern: \brief Name of the pixelmap file. */
#define INTRO_ANIMFILE   "intro.anm"    /** BRenderModern: \brief Name of the animation file. */
#define INTRO_ANIM_SPF   (1.0f / 25.0f) /** BRenderModern: \brief 1/(animation fps). */
#define INTRO_WAIT_TIME  1.0f           /** BRenderModern: \brief Time to wait after the animation, in seconds. */
#define INTRO_FADE_TIME  0.5f           /** BRenderModern: \brief Fade-out speed, in seconds. */
...
static br_material *create_word_material(void)
{
    ...
    // BRenderModern: mat->colour      = BR_COLOUR_RGB(0, 0, 0);
    // BRenderModern: mat->opacity     = 255;
...
br_intro *BrIntroCreate(void)
{
    ...
    *state = (br_intro){
        .accum       = INTRO_ANIM_SPF, /* BRenderModern: Set this initially to trigger the update immediately. */
        .frame_index = 0,
...
void BrIntroUpdate(br_intro *state, float dt)
{
    switch(state->state) {
        ...
        default:
            // BRenderModern: BrIntroReset(state);
            break;
    }
}
