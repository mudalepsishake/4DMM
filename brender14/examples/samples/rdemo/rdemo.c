/* BRenderModern: Teapot in Space */
/* BRenderModern: Simulated reflections by rendering into environment maps */

#include <stdio.h>
#include <brdemo.h>

/* BRenderModern: This demo simulates a giant reflecting teapot hanging above a */
/* BRenderModern: spinning earth */
...
br_error ReflectionInit(br_demo *demo)
{
    ...
    /* BRenderModern: Now place the main camera from which we will view the system */
    ...
    /* BRenderModern: This is the camera that will be used to provide the reflection */
    /* BRenderModern: of the earth into the teapot */
