/// BRenderModern: ///////////////////////////////////////////////////////////////////
//
// BRenderModern: Project  : BRender Forest Demo
// BRenderModern:            Copyright (c) 1996 Argonaut Technologies Ltd.
// BRenderModern:            All rights reserved.
// BRenderModern:          : Copyright(c) 2025 Zane van Iperen
//
// BRenderModern: Author         : Simon Everett
// BRenderModern: Demo Framework : Steve Williams
// BRenderModern: Ported by      : Zane van Iperen
//
// BRenderModern: File     : forest.c
//
// BRenderModern: Requires : BRender V1.4
//
// BRenderModern: Comments : Forest z-sort demo
//
// BRenderModern: SPDX-License-Identifier: Apache-2.0
//
/// BRenderModern: ///////////////////////////////////////////////////////////////////
...
// BRenderModern: Prototypes for CameraUpdate#, CameraReset#
...
static br_error ForestInit(br_demo *demo)
{
    ...
    *state = (br_demo_forest){
    ...
    // BRenderModern: Setup generic data for samples
    ...
    // BRenderModern: setup order table at root (generate new bounds,
    // BRenderModern: use average of 3 vertices for sorting buckets)

    // BRenderModern: BrZsActorOrderTableSet(root, BrZsOrderTableAllocate(1024, BR_ORDER_TABLE_NEW_BOUNDS | BR_ORDER_TABLE_SORT_NEAR, BR_SORT_MAX));
...
{
    br_demo_forest *state = demo->user;
#if 0 /* BRenderModern: Enable to use Z-buffering (much faster) instead of Z-sorting. */
