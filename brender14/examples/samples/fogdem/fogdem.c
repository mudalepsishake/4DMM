    ...
    switch(evt->type) {
        ...
        case SDL_EVENT_MOUSE_MOTION: {
            ...
            if((evt->motion.state & SDL_BUTTON_LMASK) && (evt->motion.state & SDL_BUTTON_RMASK)) {
                // BRenderModern: Drag object around in x/y plane
                ...
                // BRenderModern: Move object along z axis
                ...
                // BRenderModern: Only modify the top 3x3
...
// BRenderModern: Matrix multiply for top 3x3 only
