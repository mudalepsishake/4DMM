/// BRenderModern: ///////////////////////////////////////////////////////////////////
//
// BRenderModern: Project  : BRender Mirror Sample
// BRenderModern:            Copyright (c) 1996 Argonaut Technologies Ltd.
// BRenderModern:            All rights reserved.
//
// BRenderModern: Author         : Sam Littlewood
// BRenderModern: Demo Framework : Steve Williams
//
// BRenderModern: File     : MIRROR.C
//
// BRenderModern: Requires : BRender V1.3
// BRenderModern:            Microsoft DirectX 3.0, Win95/NT or DOS
//
// BRenderModern: Comments : Mirror demo
//
/// BRenderModern: ///////////////////////////////////////////////////////////////////
                   ...
                   br_scalar mouse_y)
{
    ...
    if((state->mouse_buttons & SDL_BUTTON_LMASK) && (state->mouse_buttons & SDL_BUTTON_RMASK)) {
        // BRenderModern: move object along the z axis
        ...
        // BRenderModern: Move object in the XY plane
        ...
        // BRenderModern: Rotate object via rolling ball interface
