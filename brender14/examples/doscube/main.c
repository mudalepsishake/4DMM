...
// BRenderModern: #define PALETTE_NAME "vga.pal" // For easier debugging
// BRenderModern: #define CLEAR_COLOUR 20
// BRenderModern: #define TEXT_COLOUR  15
